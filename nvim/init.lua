        ...
        callback = function(event)
          ...
          local function auto_import_on_escape()
            ...
            if vim.bo.filetype == 'typescript' or vim.bo.filetype == 'javascript' or 
               vim.bo.filetype == 'typescriptreact' or vim.bo.filetype == 'javascriptreact' then
          ...
          -- Detectar quando sai do modo de inserção
          vim.api.nvim_create_autocmd('InsertLeave', {
            pattern = { '*.ts', '*.tsx', '*.js', '*.jsx', '*.go' },
            callback = function()
              -- Pequeno delay para garantir que o LSP processou as mudanças
